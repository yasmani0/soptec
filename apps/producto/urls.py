...
from apps.producto.views import index, update, update1, update2, update3, detalle_producto, cart, checkout, updatePedidoEspecifico, pedidoProcesados, prueba, local_index, localupdate
